...
// 쿠키는 PC에 남아있는 반면 세션은 웹 종료 시 삭제된다.

// 쿠키
// 웹 사이트 방문 시에 사용자의 컴퓨터에 기록되는 데이터
// 클라이언트 상태 정보를 PC에 저장함으로써 재사용이 가능하다.
// ex. 웹 팝업의 오늘은 보지 않기 기능, 자동 로그인 기능
